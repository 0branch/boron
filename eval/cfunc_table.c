...
DEF_CF( cfunc_catch,   "catch val /name w\n" )
DEF_CF( cfunc_try,     "try val\n" )
DEF_CF( cfunc_recycle, "recycle\n" )
DEF_CF( cf_do,         "do :eval\n" )
DEF_CF( cfunc_set,     "set w val\n" )
DEF_CF( cfunc_get,     "get w\n" )
DEF_CF( cfunc_valueQ,  "value? w\n" )
DEF_CF( cfunc_in,      "in c w\n" )
DEF_CF( cfunc_words_of,"words-of c 0\n" )
DEF_CF( cfunc_words_of,"values-of c 1\n" )
DEF_CF( cfunc_bindingQ,"binding? w\n" )
DEF_CF( cfunc_bind,    "bind b w\n" )
DEF_CF( cfunc_unbind,  "unbind w /deep\n" )
DEF_CF( cfunc_infuse,  "infuse b w\n" )
...
DEF_CF( cfunc_sqrt,    "sqrt n\n" )
DEF_CF( cfunc_cos,     "cos n\n" )
DEF_CF( cfunc_sin,     "sin n\n" )
DEF_CF( cfunc_atan,    "atan n\n" )
DEF_CF( cfunc_make,    "make type spec\n" )
DEF_CF( cfunc_copy,    "copy val /deep\n" )
DEF_CF( cfunc_reserve, "reserve ser size\n" )
DEF_CF( cfunc_does,    "does body\n" )
DEF_CF( cfunc_func,    "func spec body\n" )
...
DEF_CF( cfunc_all,     "all val\n" )
DEF_CF( cfunc_any,     "any val\n" )
...
DEF_CF( cfunc_while,   "while exp body /ghost\n" )
DEF_CF( cfunc_forever, "forever body /ghost\n" )
DEF_CF( cfunc_loop,    "loop n body /ghost\n" )
DEF_CF( cfunc_select,  "select data val /last /case\n" )
DEF_CF( cfunc_switch,  "switch val body\n" )
DEF_CF( cfunc_case,    "case body\n" )
DEF_CF( cfunc_first,   "first ser\n" )
DEF_CF( cfunc_second,  "second ser\n" )
DEF_CF( cfunc_third,   "third ser\n" )
...
DEF_CF( cfunc_remove,  "remove ser /slice /part n\n" )
DEF_CF( cfunc_reverse, "reverse ser /part n\n" )
...
DEF_CF( cfunc_forall,     "forall 'w body /ghost\n" )
DEF_CF( cfunc_map,        "map 'w ser body /ghost\n" )
DEF_CF( cfunc_infoQ,      "exists? file 0\n" )
DEF_CF( cfunc_infoQ,      "dir? file 1\n" )
DEF_CF( cfunc_infoQ,      "info? file 2\n" )
DEF_CF( cfunc_make_dir,   "make-dir path /all\n" )
DEF_CF( cfunc_change_dir, "change-dir path\n" )
DEF_CF( cfunc_current_dir,"current-dir\n" )
DEF_CF( cfunc_getenv,     "getenv val\n" )
...
DEF_CF( cfunc_delete,     "delete file\n" )
DEF_CF( cfunc_rename,     "rename a b\n" )
DEF_CF( cfunc_load,       "load from\n" )
DEF_CF( cfunc_save,       "save to data\n" )
DEF_CF( cfunc_parse,      "parse input rules /case /binary\n" )
...
DEF_CF( cfunc_swap,       "swap b /group size\n" )
DEF_CF( cfunc_lowercase,  "lowercase s\n" )
DEF_CF( cfunc_uppercase,  "uppercase s\n" )
DEF_CF( cfunc_trim,       "trim s /indent /lines\n" )
...
DEF_CF( cfunc_serialize,  "serialize b\n" )
DEF_CF( cfunc_unserialize,"unserialize b\n" )
